...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       UserRef = FirebaseDatabase.getInstance().getReference().child("Users");
        ...
        messaReceiverID = getIntent().getExtras().get("visit_user_id").toString();
...
//        updateUserStatus("Online");
        ...
        
        {
        ...
        else
            {
                ...
                String  message_push_id =  user_nessage_key.getKey();
                        ...
                        RootRef.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                if (task.isSuccessful())
                            {
                            ...
                            else
                                {
                                    ...
                                    Toast.makeText(ChatActivity.this, "Error Occurred:" + messaege, Toast.LENGTH_SHORT).show();
                                    userMessageInput.setText("");
    ...
    private void DisplayReceiverInfo()

      {
          ...
          RootRef.child("Users").child(messaReceiverID).addValueEventListener(new ValueEventListener() {
              @Override
